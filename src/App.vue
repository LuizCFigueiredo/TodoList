<template>
  <main :class="{ 'dark': isDarkMode }" class="mt-10 flex flex-col items-center justify-center font-medium ">
    <h1 class="text-Light-TextColor dark:text-Dark-TextColor text-[26px]">TODO LIST</h1>
    <div class="flex gap-[10px] mt-4">
      <div class="relative">
        <Input id="filtro" type="text" placeholder="procurar tarefa..." />
        <svg class="absolute top-1/2 -translate-y-1/2 right-3 fill-Light-Place dark:fill-Dark-ColorPrimary " width="21"
          height="22" viewBox="0 0 21 22" xmlns="http://www.w3.org/2000/svg">
          <path
